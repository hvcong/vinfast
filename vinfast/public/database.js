    ...
    "VF3": {
        ...
        "colors": [
            ...
            },
            {
                ...
                "car_image_url": "vinfast_images/vf3/Summer Yellow Body - Infinity Blanc Roof.png",
            ...
            },
            {
                ...
                "car_image_url": "vinfast_images/vf3/Rose Pink Body - Infinity Blanc Roof.png",
...
const product_mapping = {
    ...
    'vf8': 'VF8',
    'vf9': 'VF9',
    'nimo_green': 'MINIOGREEN',
    'herio_green': 'HERIOGREEN',
    'nerio_greeb': 'NERIOGREEN',
    'limo_green': 'LIMOGREEN',
    'ecvan': 'ECVAN'
};

// Tạo danh sách tất cả các màu
const colors = [];
Object.keys(vinfast_colors_data).forEach(model => {
    vinfast_colors_data[model].colors.forEach(color => {
        if (!colors.find(c => c.ma_mau === color.code)) {
            colors.push({
                ma_mau: color.code,
                ten_mau: color.name || color.code,
                icon: color.color_icon_url || color.car_image_url
            });
        }
    });
});
...
function getColorsForProduct(productCode) {
    ...
    const productData = vinfast_colors_data[mappedCode];
    ...
    return productData.colors.map(color => ({
        ma_mau: color.code,
        ten_mau: color.name || color.code,
        hinh_anh_ngoai: color.car_image_url,
        icon: color.color_icon_url || color.car_image_url
    }));
}
...
const chi_phi_dich_vu_dang_ky = 3000000
